...
🏆 Highlights:  
- ⚡ Integrated **OpenAI GPT-3.5 API** into Slack → +20% user success @ Mentessa  
- 👥 Led 4-person Android team → **Save Tuba** for 5,000+ users  
- 🥇 Built VR learning project in **Unity/C#**, won *Best Project* (top 0.5%)  
🎯 Goal → Ship impactful, scalable software people love.  
...
🧘 **[Jaya-verse](https://github.com/rubiatExe/Jaya-verse)** — Full-stack wellness hub *(Next.js + Firebase)* with real-time sync.  
💬 **Mentessa Slack App** — Integrated **OpenAI GPT-3.5** for dynamic conversation flow (+20% success).  
🎮 **Lehigh RiVR Learning** — VR learning experience in Unity, awarded *Best Project*.  
📱 **Save Tuba** — Android app (MVVM) used by 5,000+ students, improved engagement by 12%.  
